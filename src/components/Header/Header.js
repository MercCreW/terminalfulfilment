    ...
    <section className="header">
      <nav className='header__navigation'>
        ...
        <ul className='header__navigation-list'>
          ...
          <li className='header__navigation-item'>
            <button className='header__navigation-btn header__navigation-btn_active'>оставить заявку</button>
          </li>
      ...
      <div className='header__content'>
        ...
        <h1 className='header__title'>занимайтесь
          <p className='header__text'>
            <span className='header__text_color_yellow'>развитием</span>
            <div class="arrow"></div>
          </p>
          <p className='header__text'>а не <span className='header__text_type_underline'>доставкой</span></p>
        </h1>
        <ul className='header__button-list'>
          ...
          <li className='header__list-item'>
            <button className='header__btn-item'>
              калькулятор
            </button>
          </li>
        </ul>
